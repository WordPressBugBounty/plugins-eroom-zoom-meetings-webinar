...
class Meetings extends Request {
	 ...
	 * @return array|mixed
	 */
	public function addRegistrant( string $meetingId, $data = array() ) {
	 ...
	 * @return array|mixed
	 */
	public function updateRegistrantStatus( string $meetingId, array $data = array() ) {
	 ...
	 * @return array|mixed
	 */
	public function pastMeetingParticipants( string $meetingUUID, array $query = array() ) {
