...
require_once STM_ZOOM_PATH . '/zoom-conference/TimezoneHelper.php';
require_once STM_ZOOM_PATH . '/zoom-conference/StmZoom.php';
require_once STM_ZOOM_PATH . '/zoom-conference/PostTypeCapabilities.php';
...
require_once STM_ZOOM_PATH . '/zoom-conference/StmZoomSignature.php';
